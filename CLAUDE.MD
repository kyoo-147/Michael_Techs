...
This document contains project-specific instructions and notes for AI coding agents when working on this portfolio.

## CRITICAL GUIDELINES

### NEVER CREATE BLOG POSTS WITHOUT CONSENT

- **NEVER CREATE BLOG POSTS WITHOUT EXPLICIT CONSENT** from Michael
...
5. **Fixing broken images**:
   ...
   - Use the checked-in files under `/public/` as the source of truth for current images
